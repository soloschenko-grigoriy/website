    ...
    <body>
        ...
        <section class="section pt-0">
            ...
            <div class="container-fluid">
                <div id="grid" class="row row-cols-lg-5">
                    ...
                    <div class="col-lg col-md-4 col-12 spacing picture-item" data-groups='["designing"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
                    ...
                    <div class="col-lg col-md-4 col-12 spacing picture-item" data-groups='["photography"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
                    ...
                    <div class="col-lg col-md-4 col-12 spacing picture-item" data-groups='["development"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
                    ...
                    <div class="col-lg col-md-4 col-12 spacing picture-item" data-groups='["branding", "development"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
