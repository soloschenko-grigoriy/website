                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div id="grid" class="row">
                            ...
                            <div class="col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["designing"]'>
                                <div class="card border-0">
                                    <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
                            ...
                            <div class="col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["photography"]'>
                                <div class="card border-0">
                                    <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
                            ...
                            <div class="col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["development"]'>
                                <div class="card border-0">
                                    <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
                            ...
                            <div class="col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["branding", "development"]'>
                                <div class="card border-0">
                                    <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
