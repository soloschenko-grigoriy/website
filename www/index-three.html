                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-md-9">
                        <div class="title-heading text-center">
                            <h5 class="text-muted">Minimalist Portfolio Creator</h5>
                            <h4 class="display-4 text-shadow-title fw-bold my-4">We Built <span class="text-primary">Creative</span> & <span class="text-primary">Classic</span> Brand</h4>
                            <p class="text-muted para-desc mx-auto">Porfo is a Creative Agency & Startup Studio that provides Digital Products and Services turns to focus on client success.</p>
                            <div class="mt-4">
                                <a href="work-full-masonry.html" class="btn btn-pills btn-outline-primary">More Works <span class="h5 mb-0 ms-1"><i class="uil uil-arrow-right align-middle"></i></span></a>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            ...
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="card border-0 work-container work-classic">
                            <div class="card-body p-0">
                                <a href="images/work/14.jpg" class="lightbox" title="">
                                    <img src="images/work/14.jpg" class="img-fluid rounded shadow" alt="work-image">
                                </a>
                                <div class="content text-center mt-4 pt-2">
                                    <h4><a href="javascript:void(0)" class="text-dark">Iphone mockup</a></h4>
                                    <h6 class="text-muted font-weight-normal tag mb-0 mt-3">Branding</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card border-0 work-container work-classic">
                            <div class="card-body p-0">
                                <a href="images/work/15.jpg" class="lightbox" title="">
                                    <img src="images/work/15.jpg" class="img-fluid rounded shadow" alt="work-image">
                                </a>
                                <div class="content text-center mt-4 pt-2">
                                    <h4><a href="javascript:void(0)" class="text-dark">Mockup Collection</a></h4>
                                    <h6 class="text-muted font-weight-normal tag mb-0 mt-3">Mockup</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                        ...
                        <div class="card border-0 work-container work-classic">
                            <div class="card-body p-0">
                                <a href="images/work/16.jpg" class="lightbox" title="">
                                    <img src="images/work/16.jpg" class="img-fluid rounded shadow" alt="work-image">
                                </a>
                                <div class="content text-center mt-4 pt-2">
                                    <h4><a href="javascript:void(0)" class="text-dark">Abstract images</a></h4>
                                    <h6 class="text-muted font-weight-normal tag mb-0 mt-3">Abstract</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-12 mt-5 pt-3">
                        <div class="card border-0 work-container work-classic">
                            <div class="card-body p-0">
                                <a href="images/work/17.jpg" class="lightbox" title="">
                                    <img src="images/work/17.jpg" class="img-fluid rounded shadow" alt="work-image">
                                </a>
                                <div class="content text-center mt-4 pt-2">
                                    <h4><a href="javascript:void(0)" class="text-dark">Yellow bg with Books</a></h4>
                                    <h6 class="text-muted font-weight-normal tag mb-0 mt-3">Books</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-12 mt-5 pt-3">
                        <div class="card border-0 work-container work-classic">
                            <div class="card-body p-0">
                                <a href="images/work/18.jpg" class="lightbox" title="">
                                    <img src="images/work/18.jpg" class="img-fluid rounded shadow" alt="work-image">
                                </a>
                                <div class="content text-center mt-4 pt-2">
                                    <h4><a href="javascript:void(0)" class="text-dark">Company V-card</a></h4>
                                    <h6 class="text-muted font-weight-normal tag mb-0 mt-3">V-card</h6>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
