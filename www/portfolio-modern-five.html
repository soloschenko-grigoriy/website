        ...
        <section class="section pt-0">
            ...
            <div class="container-fluid">
                <div id="grid" class="row row-cols-lg-5">
                    <div class="col-lg col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["branding"]'>
                    ...
                    <div class="col-lg col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["designing"]'>
                        <div class="card border-0">
                            <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
                    ...
                    <div class="col-lg col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["photography"]'>
                        <div class="card border-0">
                            <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
                    ...
                    <div class="col-lg col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["development"]'>
                        <div class="card border-0">
                            <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
                    ...
                    <div class="col-lg col-md-6 col-12 mt-4 pt-2 picture-item" data-groups='["branding", "development"]'>
                        <div class="card border-0">
                            <div class="card-body work-container work-modern position-relative d-block overflow-hidden rounded p-0">
