                ...
                <div class="row mt-5 align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="title-heading text-center text-md-start">
                            <h4 class="display-4 fw-bold my-4 my-sm-0">We are professional creator</h4>
                        </div>
                    </div><!--end col-->
                    
                    <div class="col-lg-3 col-md-4 text-center text-md-end">
                        <a href="work-masonry.html" class="btn btn-pills btn-primary">See Works <span class="h5 mb-0 ms-1"><i class="uil uil-arrow-right align-middle"></i></span></a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
            ...
            <div class="container-fluid">
                ...
                <div class="row text-center">
                    <div class="col-12 mt-4 pt-2">
                        <a href="work-full-masonry.html" class="btn btn-pills btn-soft-primary">See works</a>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
