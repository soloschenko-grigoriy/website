                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-lg-12">
                        <div class="title-heading">
                            <h1 class="page-title display-2 text-shadow-title text-center mb-0">Works & Portfolio</h1>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        ...
        <section class="section pt-0">
            ...
            <div class="container-fluid">
                <div id="grid" class="row">
                    <div class="col-lg-2 col-md-4 col-12 spacing picture-item" data-groups='["branding"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                    ...
                    <div class="col-lg-2 col-md-4 col-12 spacing picture-item" data-groups='["designing"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
                    ...
                    <div class="col-lg-2 col-md-4 col-12 spacing picture-item" data-groups='["photography"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
                    ...
                    <div class="col-lg-2 col-md-4 col-12 spacing picture-item" data-groups='["development"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
                    ...
                    <div class="col-lg-2 col-md-4 col-12 spacing picture-item" data-groups='["branding", "development"]'>
                        <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                            <div class="card-body p-0">
