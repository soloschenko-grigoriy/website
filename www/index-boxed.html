    ...
    <body>
        <div id="sThemes-layout">
            <div class="sThemesbox">
                <!-- Navbar STart -->
                <header id="topnav" class="defaultscroll boxed-home sticky">
                    <div class="container">
                        <!-- Logo container-->
                        ...
                        <div class="row mt-5 align-items-center">
                            <div class="col-lg-8">
                                <div class="title-heading">
                                    ...
                                    <h4 class="heading fw-bold my-4">Award winning digital design agency based in London</h4>
                                    ...
                                    <div class="mt-2">
                                        <a href="aboutus.html" class="btn btn-pills btn-primary mt-2">Portfolio</a>
                                        <a href="contact.html" class="btn btn-pills btn-outline-primary mt-2 ms-2">Get in touch !</a>
                                    </div>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                ...
                <section class="section pt-0">
                    <div class="container">
                        ...
                        <div id="grid" class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-12 spacing picture-item" data-groups='["branding", "development"]'>
                                <div class="card border-0 work-container work-grid work-creative position-relative d-block overflow-hidden rounded shadow">
                                    <div class="card-body p-0">
