            ...
            <div class="container">
                <div class="row pt-5">
                    ...
                    <div class="col-lg-7 col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="row me-lg-4 sticky-sidebar">
                            <div class="col-lg-12">
                                <div class="work-details">
                                    <h5 class="title mb-3 border-bottom pb-3">Project Name :</h5>
                            ...
                            <div class="col-lg-7 mt-4 pt-2">
                                <div class="work-details bg-light p-4">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li class="mt-3">
                                            <b>Demo :</b>
                                            <span><a href="javascript:void(0)" class="text-primary">Demo link</a></span>
                                        </li>
                                    </ul>                          
                                </div>
                            </div><!--end col-->
                    ...
                    <div class="col-lg-5 col-md-6 order-1 order-md-2">
                        <div class="port-images sticky-sidebar">
                            <img src="images/work/1.jpg" class="img-fluid mx-auto d-block rounded" alt="img">
                            <img src="images/work/2.jpg" class="img-fluid mx-auto d-block rounded mt-4" alt="img">
                            <img src="images/work/3.jpg" class="img-fluid mx-auto d-block rounded mt-4" alt="img">
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
